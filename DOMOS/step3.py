...
DOMOS_filenames = next(walk(DOMOS_EO_datasets_path), (None, None, []))[2]  # [] if no file

for DOMOS_file_count,DOMOS_filename in enumerate(DOMOS_filenames):

    DOMOS_file    = DOMOS_EO_datasets_path + '\\' + DOMOS_filename
